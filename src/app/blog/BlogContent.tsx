    ...
    <>
      ...
      <SectionWrapper spacing="spacious">
        <SectionTitle
          ...
          subtitle="Stay informed with the latest security research, product updates, and engineering deep-dives from the Panguard AI team."
        />
      </SectionWrapper>
        ...
        <FadeInUp>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-text-secondary mt-4 leading-relaxed">
              Get curated threat intelligence, product updates, and engineering
              insights delivered to your inbox every Thursday. No spam, no fluff
              -- just actionable security knowledge.
            </p>
          </div>
        </FadeInUp>
        <FadeInUp delay={0.1}>

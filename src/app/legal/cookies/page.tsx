  ...
  return (
    <article className="prose-legal">
      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        <section>
          <p>
            This Cookie Policy explains how Panguard AI, Inc. (&quot;Panguard,&quot;
            &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) uses cookies and
            similar tracking technologies when you visit our website at
            panguard.ai and use our services. This policy should be read
            alongside our{" "}
            <a
              href="/legal/privacy"
        ...
        <section>
          ...
          <p>
            ...
            make websites work more efficiently, to provide a better user
            experience, and to provide information to the operators of the
            website. Cookies may be &quot;session&quot; cookies (deleted when you
            close your browser) or &quot;persistent&quot; cookies (remaining on
        ...
        <section>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-border">
                  <th className="py-2 pr-4 text-text-primary font-medium">
                    Cookie
                  </th>
                  <th className="py-2 pr-4 text-text-primary font-medium">
                    Purpose
                  </th>
                  <th className="py-2 text-text-primary font-medium">
                    Duration
                  </th>
                </tr>
              </thead>
          ...
          <p className="mt-3">
            ...
            website to function properly. They do not store any personally
        ...
        <section>
          ...
          <p>
            ...
            website. These cookies help us measure traffic patterns, identify
            popular content, and improve the user experience. All analytics data
            is collected in aggregate form and cannot be used to identify
            individual users.
          </p>
          <div className="mt-3 overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-text-secondary">
                <tr className="border-b border-border/50">
                  ...
                  <td className="py-2 pr-4">
                    Privacy-focused analytics (self-hosted)
                  </td>
          ...
          <p className="mt-3">
            We use a self-hosted, privacy-focused analytics solution. We do not
            use Google Analytics or any third-party analytics provider that
        ...
        <section>
          ...
          <p>
            ...
            Panguard does not serve third-party advertisements on our website,
            nor do we use tracking cookies to deliver targeted advertising
            across other websites. We believe your security platform should not
            be tracking you for marketing purposes.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-2 space-y-2">
            <li>
              ...
              existing cookies, or alert you when a cookie is being set. Please
            ...
            <li>
              ...
              opt out of analytics cookies at any time through your account
              settings or by contacting us at privacy@panguard.ai.
            </li>
          </ul>
          <p className="mt-3">
            Please note that disabling essential cookies may prevent you from
            using certain features of our website and services.
          </p>
        </section>

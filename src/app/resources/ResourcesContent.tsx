...
function ctaLabel(type: Resource["type"]): string {
  return type === "Webinar" ? "Watch" : "Download";
}
    ...
    <>
      ...
      <SectionWrapper spacing="spacious">
        <SectionTitle
          ...
          subtitle="Whitepapers, reports, and guides to help your team build stronger security."
        />
      </SectionWrapper>
        ...
        <FadeInUp>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-text-secondary mt-4 leading-relaxed">
              Stay ahead of the threat landscape with curated whitepapers,
              reports, and guides delivered directly to your inbox. No spam

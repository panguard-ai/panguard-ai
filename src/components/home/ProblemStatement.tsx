...
import { ShieldIcon, ResponseIcon, TerminalIcon } from "@/components/ui/BrandIcons";
  ...
  return (
    <SectionWrapper>
      <SectionTitle
        ...
        subtitle="Your antivirus shows an alert. A port scan was detected. An unusual login attempt. You're not a security expert. You don't have an IT team. The dashboard is full of codes you don't understand."
      />
      <FadeInUp delay={0.1}>

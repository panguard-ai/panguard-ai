...
<CardGroup cols={3}>
  <Card title="ATR -- 標準" icon="file-code">
    **61 條規則，9 大威脅類別。** AI Agent 威脅偵測的第一個開放標準 -- 專門對付 prompt
  ...
  <Card title="Guard -- 引擎" icon="shield-halved">
    **61 條 ATR 偵測規則。** 4-Agent AI 管線（Detect、Analyze、Respond、Report）用 ATR 規則處理 OS
...
<CardGroup cols={2}>
  ...
  <Card title="MCP Server" icon="plug">
    **AI 助手整合。** 11 個 MCP 工具讓 Claude Desktop、Cursor、Claude Code 直接用自然語言操作
    Panguard。
  </Card>

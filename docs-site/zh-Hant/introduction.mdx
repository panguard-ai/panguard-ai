...
title: 'Panguard AI'
sidebarTitle: '簡介'
description: 'AI Agent 安全的第一個開放標準。344 條 ATR 偵測規則。OWASP Agentic Top 10: 10/10 覆蓋。16 個平台。100% 免費開源。'
icon: 'shield-check'
---

<Note>
  **v1.5.6 已發布** -- 支援 16 個 AI 平台、344 條 ATR 規則、OWASP Agentic Top 10 完整覆蓋、ClawHub 生態系掃描（36,394 個 Skills）。[查看更新日誌](/changelog)。
</Note>
...
論文涵蓋：威脅分類體系、偵測架構（regex + LLM crystallization）、PINT benchmark 評測（62.7% recall, 99.7% precision），以及 64 種已記錄的繞過技術。

...
title: 'Panguard AI'
sidebarTitle: '簡介'
description: 'AI Agent 安全的第一個開放標準。714 條 ATR 偵測規則。OWASP Agentic Top 10: 10/10 覆蓋。17 個平台。Community 永久免費開源。'
icon: 'shield-check'
---

<Note>
  **v1.8.3 已發布** -- 支援 17 個 AI 平台、714 條 ATR 規則、OWASP Agentic Top 10 完整覆蓋、67,799 個 skills 掃描 · 1,096 個確認惡意。[查看更新日誌](/changelog)。
</Note>
...
<CardGroup cols={3}>
  <Card title="ATR -- 標準" icon="file-code" href="/overview">
    **714 條規則，10 大威脅類別。** AI Agent 威脅偵測的第一個開放標準 -- prompt injection、tool
  ...
  <Card title="Guard -- 引擎" icon="shield-halved" href="/products/guard/overview">
    **4-Agent AI 管線。** Detect、Analyze、Respond、Report。用 714 條 ATR 規則處理 OS 層級事件。內建
...
- **Community 永久免費** -- MIT 授權、714 條 ATR 規則、無限自架、無需註冊。生產級 F500 部署可選 [Enterprise（$150K-500K / 年）](https://panguard.ai/zh-TW/pricing)、[Migrator Pro（$500K-2M / 年）](https://panguard.ai/zh-TW/pricing)、或 [Sovereign（$5-20M / 國家）](https://panguard.ai/zh-TW/pricing),內含簽章、持續重掃的合規 evidence、離網部署、SLA。

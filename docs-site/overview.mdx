...
<CardGroup cols={3}>
  <Card title="ATR -- The Standard" icon="file-code">
    **61 rules across 9 threat categories.** The first open standard for AI agent threats --
  ...
  <Card title="Guard -- The Engine" icon="shield-halved">
    **61 ATR detection rules.** A 4-agent AI pipeline (Detect, Analyze, Respond, Report) processes

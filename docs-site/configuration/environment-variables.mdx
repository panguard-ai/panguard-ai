...
export CORS_ALLOWED_ORIGINS=https://dashboard.panguard.ai  # Dashboard is Coming Soon
```
...
services:
  manager:
    ...
    environment:
      ...
      - CORS_ALLOWED_ORIGINS=https://dashboard.panguard.ai  # Dashboard is Coming Soon

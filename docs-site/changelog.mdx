...
- `panguard setup` auto-detects and configures 8 AI platforms in one command
...
- 7-layer pre-install security gate for AI skills
...
- 9,790 total detection rules shipped with install
- Sigma: 3,760 (3,110 community + 605 auto-gen + 45 custom)
- YARA: 5,961 (969 files, multi-rule split)
- ATR: 69 (52 stable + 17 predicted drafts)

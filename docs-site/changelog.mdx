...
**Released: 2026-07-10** -- Current stable release. ATR v3.5.7 (714 rules), OWASP Agentic Top 10: 10/10 covered.

### Highlights

- **714 ATR rules** across 10 threat categories (was 419 in v2.2.0), now with **detection lanes**: enforce (stable, confirm-gated rules) ~0.24% FP / hunt (all rules, default) ~9% FP, measured on a 65,000-sample benign corpus
...
- **1.8.3 fix**: DNS-rebind SSRF pinning + monotonic retention-floor

...
**Released: 2026-05-12** -- Latest stable release alongside ATR v2.1.3 (344 rules)

### Highlights

- **ATR v2.1.3** with 344 rules (was 71 in v2.0.x) covering 10 threat categories
...
**Released: 2026-03-25** -- 16 Platforms, OWASP 10/10, 344 ATR Rules
...
- **344 ATR rules** (up from 61), covering 10 new attack categories
...
- 344 ATR detection rules shipped with install

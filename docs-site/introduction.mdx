...
description: 'The first open standard for AI agent security. 714 ATR detection rules. OWASP Agentic Top 10: 10/10 covered. 17 platforms. Community is free and open source.'
icon: 'shield-check'
---

<Note>
  **v1.8.3 released** -- 17 AI platform support, 714 ATR rules, OWASP Agentic Top 10 full coverage, 67,799 skills scanned with 1,096 confirmed malicious.
...
|                                    |                                                                                                                                         |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| **714** detection rules            | ATR (714) + community                                                                                                                   |
...
<CardGroup cols={3}>
  <Card title="ATR -- The Standard" icon="file-code" href="/overview">
    **714 rules across 10 threat categories.** The first open standard for AI agent threats -- prompt
  ...
  <Card title="Guard -- The Engine" icon="shield-halved" href="/products/guard/overview">
    **4-agent AI pipeline.** Detect, Analyze, Respond, Report. Processes OS-level events through 714
...
- **Community is free** -- MIT licensed, 714 ATR rules, unlimited self-host, no signup required. For production deployments at F500 scale, [Enterprise ($150K-500K / year)](https://panguard.ai/pricing), [Migrator Pro ($500K-2M / year)](https://panguard.ai/pricing), and [Sovereign ($5-20M / nation)](https://panguard.ai/pricing) tiers add signed, continuously re-scanned compliance evidence, airgap deployment, and SLA.

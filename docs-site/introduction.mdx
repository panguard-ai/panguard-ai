...
| | |
| --- | --- |
| **125+** detection rules | ATR (125) + community |
...
<CardGroup cols={3}>
  <Card title="ATR -- The Standard" icon="file-code" href="/overview">
    **125 rules across 9 threat categories.** The first open standard for AI agent threats -- prompt injection, tool poisoning, skill compromise, agent manipulation. YAML-based, human-readable, machine-enforceable.
  </Card>

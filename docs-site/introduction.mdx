...
description: 'The first open standard for AI agent security. 747 ATR detection rules. OWASP Agentic Top 10: 10/10 covered. 17 platforms. Community is free and open source.'
icon: 'shield-check'
---

<Note>
  **v1.8.23 released** -- 17 AI platform support, 747 ATR rules, OWASP Agentic Top 10 full coverage, 67,799 skills scanned with 1,096 confirmed malicious.

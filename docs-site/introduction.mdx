...
description: 'The first open standard for AI agent security. 101 ATR detection rules. OWASP Agentic Top 10: 10/10 covered. 16 platforms. 100% free and open source.'
icon: 'shield-check'
---

<Note>
  **v1.4.2 released** -- 16 AI platform support, 101 ATR rules, OWASP Agentic Top 10 full coverage, 90,000+ skills scanned.
...
<CardGroup cols={3}>
  <Card title="ATR -- The Standard" icon="file-code" href="/overview">
    **101 rules across 9 threat categories.** The first open standard for AI agent threats -- prompt

...
description: 'The first open standard for AI agent security. 71 ATR detection rules. OWASP Agentic Top 10: 10/10 covered. 16 platforms. 100% free and open source.'
icon: 'shield-check'
---

<Note>
  **v1.4.2 released** -- 16 AI platform support, 71 ATR rules, OWASP Agentic Top 10 full coverage, ClawHub ecosystem scan (36,394 skills).
...
|                                    |                                                                                                                                         |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| **71** detection rules             | ATR (71) + community                                                                                                                    |
...
<CardGroup cols={3}>
  <Card title="ATR -- The Standard" icon="file-code" href="/overview">
    **71 rules across 9 threat categories.** The first open standard for AI agent threats -- prompt
  ...
  <Card title="Guard -- The Engine" icon="shield-halved" href="/products/guard/overview">
    **4-agent AI pipeline.** Detect, Analyze, Respond, Report. Processes OS-level events through 71
...
The paper covers: threat taxonomy, detection architecture (regex + LLM crystallization), PINT benchmark evaluation (62.7% recall, 99.7% precision), and 64 documented evasion techniques.

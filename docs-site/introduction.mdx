...
description: "The first open standard for AI agent security. 61 ATR detection rules. One-line install. 100% free and open source."
icon: "shield-check"
---

<Note>
  **v1.3.0 released** -- Built-in dashboard, 8 AI platform support, Skill Auditor as default entry point. [See changelog](/changelog).
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="Guard -- The Engine" icon="shield-halved" href="/products/guard/overview">
    **4-agent AI pipeline.** Detect, Analyze, Respond, Report. Processes OS-level events through 61 ATR rules. Built-in Skill Auditor. Auto-response blocks IPs, kills processes, quarantines files.
  </Card>
</CardGroup>

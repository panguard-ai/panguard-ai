...
<Note>
  **v1.3.0 released** -- Built-in dashboard, 8 AI platform support, Skill Auditor as default entry
  point. [See changelog](/changelog).
</Note>
...
<CardGroup cols={3}>
  <Card title="ATR -- The Standard" icon="file-code" href="/overview">
    **61 rules across 9 threat categories.** The first open standard for AI agent threats -- prompt
  ...
  <Card title="Guard -- The Engine" icon="shield-halved" href="/products/guard/overview">
    **4-agent AI pipeline.** Detect, Analyze, Respond, Report. Processes OS-level events through 61

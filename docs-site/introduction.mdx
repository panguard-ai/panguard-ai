...
description: 'The first open standard for AI agent security. 344 ATR detection rules. OWASP Agentic Top 10: 10/10 covered. 16 platforms. Community is free and open source.'
icon: 'shield-check'
---

<Note>
  **v1.5.6 released** -- 16 AI platform support, 344 ATR rules, OWASP Agentic Top 10 full coverage, 67,799 skills scanned with 1,096 confirmed malicious.
...
|                                    |                                                                                                                                         |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| **344** detection rules            | ATR (344) + community                                                                                                                   |
...
<CardGroup cols={3}>
  ...
  <Card title="Guard -- The Engine" icon="shield-halved" href="/products/guard/overview">
    **4-agent AI pipeline.** Detect, Analyze, Respond, Report. Processes OS-level events through 344
...
- **Community is free** -- MIT licensed, 344 ATR rules, unlimited self-host, no signup required. For production deployments at F500 scale, [Pilot ($25K / 90 days)](https://panguard.ai/pricing), [Enterprise ($150K-500K / year)](https://panguard.ai/pricing), and [Sovereign ($5-20M / nation)](https://panguard.ai/pricing) tiers add Migrator Pro, 5-framework compliance evidence, airgap deployment, and SLA.
...
The paper covers: threat taxonomy, detection architecture (regex + LLM crystallization), PINT MCP benchmark evaluation (62.5% recall, 99.6% precision on 850 samples), SKILL.md benchmark (100% recall, 97% precision, 0.2% FP on 498 real-world samples), Garak benchmark (97.1% recall on 666 samples), and 64 documented evasion techniques.

...
description: "The first open standard for AI agent security. 9,790 detection rules. One-line install. 100% free and open source."
icon: "shield-check"
---

<Note>
  **v0.8.0 released** -- Built-in dashboard, OpenClaw & QClaw native support, Skill Auditor as default entry point. [See changelog](/changelog).
</Note>
...
| | |
| --- | --- |
| **9,790** detection rules | Sigma (3,760) + YARA (5,961) + ATR (69) |
...
<CardGroup cols={3}>
  <Card title="ATR -- The Standard" icon="file-code" href="/overview">
    **69 rules across 9 threat categories.** The first open standard for AI agent threats -- prompt injection, tool poisoning, skill compromise, agent manipulation. YAML-based, human-readable, machine-enforceable.
  </Card>
  ...
  <Card title="Guard -- The Engine" icon="shield-halved" href="/products/guard/overview">
    **4-agent AI pipeline.** Detect, Analyze, Respond, Report. Processes OS-level events through 9,790 rules. Built-in Skill Auditor. Auto-response blocks IPs, kills processes, quarantines files.
  </Card>
</CardGroup>

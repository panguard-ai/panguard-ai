...
<CardGroup cols={3}>
  <Card title="Auth Server API" icon="user-shield">
    **Port 3000** -- User registration, login, sessions, TOTP two-factor, and GDPR compliance.
  </Card>
...
|---------|-----------------|-----|
| Auth Server | `http://localhost:3000` or `http://localhost:3000` | Optional (recommended) |

...
| **Technology** | Sigma + YARA | Ollama (llama3) | Claude / OpenAI |
...
Sigma is the community standard rule format for security detection. Panguard Guard ships with 3,760 Sigma + 5,961 YARA + 69 ATR rules (9,700+ total) covering common attack patterns.

<CodeGroup>
```yaml Sigma Rule Example

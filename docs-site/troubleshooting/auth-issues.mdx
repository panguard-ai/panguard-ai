...
Panguard is 100% open source (MIT license) -- all features are available to every user at no cost. If you see this error, you may be running an outdated version.

**Solution:**

Update to the latest version:
```bash
npm install -g panguard@latest
```

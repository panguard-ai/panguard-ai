...
Panguard is 100% open source (MIT license) -- all features are available to every user at no cost. If you see this error, you are running an outdated version that still contained tier restrictions.

**Solution:**

Update to the latest version:
```bash
npm install -g @panguard-ai/panguard@latest
```
...
<AccordionGroup>
  <Accordion title="Popup blocked">
    Allow popups from `auth.panguard.ai` in your browser settings.
  </Accordion>

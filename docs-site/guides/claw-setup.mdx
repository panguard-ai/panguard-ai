---
title: "Install on OpenClaw & QClaw"
description: "One-command setup guide for OpenClaw and QClaw (Tencent). No account required."
icon: "bolt"
---

Install Panguard on your Claw-based AI agent in under 60 seconds. No account, no login, no configuration.

## Quick Start (All Platforms)

The fastest way -- one command detects and configures everything:

```bash
npx panguard setup
```

This auto-detects OpenClaw, QClaw, and all other AI platforms on your machine, then injects the correct configuration for each.
...
| | OpenClaw | QClaw |
| --- | --- | --- |
| **Protocol** | Native Skill | MCP |
| **Config path** | `~/.openclaw/skills/panguard/SKILL.md` | `~/.qclaw/mcp.json` |
| **Setup command** | `npx panguard setup` | `npx panguard setup` |

...
This checks all installed skills against 714 ATR rules covering all 10 OWASP Agentic Top 10 categories -- prompt injection, tool poisoning, credential theft, and more.
...
Rules:      714 ATR detection rules (OWASP 10/10)

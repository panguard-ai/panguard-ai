...
<Steps>
  ...
  <Step title="Connect your AI agents">
    ...
    This detects and configures Claude Code, Cursor, OpenClaw, Codex CLI, Claude Desktop, and Windsurf automatically. Each platform gets MCP or native skill integration so your AI agents can use Panguard security tools directly.

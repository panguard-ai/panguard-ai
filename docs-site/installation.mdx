...
1. **Installed Panguard** — CLI + 61 ATR detection rules
2. **Connected your AI agents** — auto-detected Claude Code, Cursor, OpenClaw, and [5 more platforms](/guides/claw-setup)

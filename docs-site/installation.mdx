...
This detects and configures Claude Code, Claude Desktop, Cursor, OpenClaw, Codex, WorkBuddy, NemoClaw, ArkClaw, and more automatically. See [Quick Start](/quickstart) for details.

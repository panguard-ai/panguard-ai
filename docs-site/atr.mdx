...
description: 'Open standard for detecting threats to AI agents. 714 rules. OWASP Agentic Top 10: 10/10 covered. Community-maintained.'
icon: 'shield-halved'
---
...
|                      |                                                        |
| -------------------- | ------------------------------------------------------ |
| **714** rules        | Covering 10 threat categories                          |
| **OWASP 10/10**      | Full coverage of OWASP Agentic Top 10                  |
| **97.2%** recall     | On Garak jailbreak corpus (650 samples)                |

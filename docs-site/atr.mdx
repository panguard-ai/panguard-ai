...
description: 'Open standard for detecting threats to AI agents. 747 rules. OWASP Agentic Top 10: 10/10 covered. Community-maintained.'
icon: 'shield-halved'
---
...
|                      |                                                        |
| -------------------- | ------------------------------------------------------ |
| **747** rules        | Covering 10 threat categories                          |

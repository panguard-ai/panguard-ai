...
description: 'Open standard for detecting threats to AI agents. 344 rules. OWASP Agentic Top 10: 10/10 covered. Community-maintained.'
icon: 'shield-halved'
---
...
|                      |                                                        |
| -------------------- | ------------------------------------------------------ |
| **344** rules        | Covering 10 threat categories                          |

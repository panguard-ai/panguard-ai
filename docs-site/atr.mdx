...
description: 'Open standard for detecting threats to AI agents. 71 rules. OWASP Agentic Top 10: 10/10 covered. Community-maintained.'
icon: 'shield-halved'
---
...
|                      |                                                        |
| -------------------- | ------------------------------------------------------ |
| **71** rules         | Covering 9 threat categories                           |
| **OWASP 10/10**      | Full coverage of OWASP Agentic Top 10                  |
| **62.7%** recall     | On PINT benchmark (99.7% precision)                    |

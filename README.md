...
| [`@openclaw/web`](packages/web) | React frontend: Vite + TailwindCSS, 6 pages, bilingual (en/zh-TW), interactive setup guide |
...
openclaw-security/
  ...
  tests/
    integration/    # Cross-package integration tests (162 tests)

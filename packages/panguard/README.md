...
AI-powered security for agents and servers — detect threats in real-time, on-device, with 747 open-source detection rules.
...
- **747 Detection Rules** — ATR (Agent Threat Rules) community-driven, LLM-reviewed standards
...
3. **Detection Rules** — Based on ATR (Agent Threat Rules), an open standard with 747 rules

    ...
    <article className="prose-legal">
      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          ...
          <p>
            Threat Cloud writes an append-only audit log of all admin actions, configuration
            changes, and rule promotions, with SHA-256 content hashing for tamper-evidence on each
            row. A full tamper-evident hash chain is on the roadmap. The schema is at{' '}

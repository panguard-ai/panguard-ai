  ...
  return (
    <article className="prose-legal">
      ...
      <div className="space-y-8 text-sm text-text-secondary leading-relaxed">
        <section>
          <p>
            Panguard AI, Inc. (&quot;Panguard,&quot; &quot;we,&quot;
            &quot;us,&quot; or &quot;our&quot;) is committed to protecting the
            privacy of individuals who visit our website at panguard.ai, use our
            products and services, or otherwise interact with us. This Privacy
            Policy describes how we collect, use, disclose, and safeguard your
            information.
          </p>
          <p className="mt-3">
            By accessing or using any Panguard service, you acknowledge that you
        ...
        <section>
          ...
          <p>
            When you register for a Panguard account, we collect your name,
            email address, organization name, billing address, and payment
            information. Payment information is processed by our PCI-compliant
          ...
          <p>
            Our endpoint protection agent collects anonymized system telemetry
            data, including operating system version, hardware configuration
            identifiers (hashed), installed software inventory, and network
            configuration metadata. All telemetry data is stripped of personally
            identifiable information before transmission and is used exclusively
          ...
          <p>
            ...
            interface interactions. This data helps us improve our product
            experience and is processed in aggregate form.
          </p>
          ...
          <p>
            When our security agent detects potential threats, anonymized
            indicators of compromise (IOCs), file hashes, and behavioral
            signatures are transmitted to our threat intelligence platform. This
            data does not contain personal files, documents, or identifiable user
            content. Threat data is used to improve detection capabilities across
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>
              To provide, maintain, and improve our security products and
              services
            </li>
            <li>
            ...
            <li>
              To send you technical alerts, security advisories, and support
              messages
            </li>
            <li>
              To conduct research and analysis to enhance our AI threat detection
              models
            </li>
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>
              ...
              We engage trusted third-party service providers who perform
              services on our behalf, such as cloud hosting (infrastructure
              providers), payment processing, and customer support tools. These
              providers are contractually obligated to protect your data and may
              only use it to perform services for us.
            </li>
            <li>
            ...
            <li>
              ...
              We may share aggregated, non-identifiable threat intelligence data
              with industry partners and security researchers to advance
        ...
        <section>
          ...
          <p>
            ...
            active or as needed to provide you services. Account information is
            retained for up to 12 months after account closure for legal and
            audit purposes. Anonymized telemetry and threat data may be retained
            indefinitely as it cannot be linked to individual users. You may
            request deletion of your account data at any time by contacting us at
            privacy@panguard.ai.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            regarding your personal data under the General Data Protection
            Regulation (GDPR) and other applicable privacy laws:
          </p>
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>
              <strong className="text-text-primary">Right of Access:</strong> You
            ...
            <li>
              <strong className="text-text-primary">Right to Object:</strong> You
          ...
          <p className="mt-3">
            ...
            privacy@panguard.ai. We will respond to your request within 30 days.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            improve our website. For detailed information about the cookies we
            use and how to manage them, please refer to our{" "}
            <a
              href="/legal/cookies"
        ...
        <section>
          ...
          <p>
            Panguard AI, Inc. is headquartered in Taipei, Taiwan. Your
            information may be transferred to, stored, and processed in
            jurisdictions other than your own. When we transfer personal data
            ...
            European Commission, adequacy decisions, or other legally recognized
            transfer mechanisms. Our data processing infrastructure is hosted on
            SOC 2 Type II certified cloud providers with data centers in
        ...
        <section>
          ...
          <p>
            ...
            promptly. If you believe that a child under 16 has provided us with
            personal data, please contact us at privacy@panguard.ai.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            additional notice via email or through our platform. Your continued

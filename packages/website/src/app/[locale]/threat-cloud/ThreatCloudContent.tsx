            ...
            <div className="bg-surface-2 rounded-xl border border-border p-5">
              ...
              <div className="flex items-center gap-4 mt-4 text-xs text-text-muted">
                <span>
                  ...
                  <strong className="text-text-primary">{STATS.threatIntel.syncInterval}</strong>
                </span>
                <span>
                  {t('liveIntel.stats.lastSync')}:{' '}
                  <strong className="text-text-primary">{STATS.threatIntel.lastSync}</strong>
                </span>
              </div>
            </div>
          </FadeInUp>

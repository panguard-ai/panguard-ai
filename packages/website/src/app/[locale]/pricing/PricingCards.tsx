...
const comparisonCategories: { categoryKey: string; rows: FeatureRow[] }[] = [
  {
    ...
    rows: [
      { feature: "Panguard Scan", free: "Full", solo: "Full", pro: "Full", enterprise: "Full + custom" },
      { feature: "Guard detection", free: "Layer 1", solo: "Layer 1+2+3", pro: "Layer 1+2+3", enterprise: "Layer 1+2+3" },
      { feature: "Auto-block attacks", free: "Known patterns", solo: "All threats", pro: "All threats", enterprise: "All threats" },
      { feature: "Auto-fix vulnerabilities", free: "Manual guide", solo: "One-click", pro: "One-click", enterprise: "One-click" },
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Log retention", free: "Session only", solo: "7 days", pro: "30 days", enterprise: "90 days+" },

...
export default function ConsoleSidebar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="flex items-center gap-2" style={{ padding: '20px 20px 16px' }}>
        <div
        ...
        <span className="font-display" style={{ fontSize: 14, fontWeight: 700, color: '#F5F1E8' }}>
          PanGuard
        </span>
        <span
          style={{
      ...
      <div className="mt-auto" style={{ padding: '16px 20px', borderTop: '1px solid #3A3836' }}>
        <Link href="/" className="no-underline" style={{ fontSize: 12, color: '#A09A94' }}>
          Back to panguard.ai
        </Link>
      </div>
    </aside>

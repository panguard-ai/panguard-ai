...
const BRIEF_HTML = `<div class="sv">
  ...
  <div class="roster-sec">
    <div class="wrap">
      ...
      <div class="roster reveal"><span class="nchip" title="United States"><span class="ncode">US</span><span class="nname">United States</span></span><span class="nchip" title="United Kingdom"><span class="ncode">GB</span><span class="nname">United Kingdom</span></span><span class="nchip" title="European Union"><span class="ncode">EU</span><span class="nname">European Union</span></span><span class="nchip" title="Japan"><span class="ncode">JP</span><span class="nname">Japan</span></span><span class="nchip" title="Singapore"><span class="ncode">SG</span><span class="nname">Singapore</span></span><span class="nchip" title="South Korea"><span class="ncode">KR</span><span class="nname">South Korea</span></span><span class="nchip" title="France"><span class="ncode">FR</span><span class="nname">France</span></span><span class="nchip" title="Germany"><span class="ncode">DE</span><span class="nname">Germany</span></span><span class="nchip" title="Canada"><span class="ncode">CA</span><span class="nname">Canada</span></span><span class="nchip" title="Australia"><span class="ncode">AU</span><span class="nname">Australia</span></span><span class="nchip" title="UAE"><span class="ncode">AE</span><span class="nname">UAE</span></span><span class="nchip" title="Saudi Arabia"><span class="ncode">SA</span><span class="nname">Saudi Arabia</span></span><span class="nchip" title="India"><span class="ncode">IN</span><span class="nname">India</span></span><span class="nchip" title="Israel"><span class="ncode">IL</span><span class="nname">Israel</span></span><span class="nchip" title="Taiwan"><span class="ncode">TW</span><span class="nname">Taiwan</span></span><span class="nchip" title="Switzerland"><span class="ncode">CH</span><span class="nname">Switzerland</span></span><span class="nchip" title="Netherlands"><span class="ncode">NL</span><span class="nname">Netherlands</span></span></div>
    </div>
  </div>

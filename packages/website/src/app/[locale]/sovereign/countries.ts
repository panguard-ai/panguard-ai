...
export const SOVEREIGN_COUNTRIES: Readonly<Record<string, SovereignCountry>> = {
  TW: {
    ...
    crosswalk: [
      {
        capability: 'Signed decision ledger',
        frameworks: '資通安全管理法 · 資通系統防護基準（高）· NIST 800-53 AU',
      },
      {
        capability: 'Policy-as-code + least-privilege',
        frameworks: '資通系統防護基準 — 存取控制 · 資通安全責任等級分級辦法',
      },
      {
        capability: 'Human approval + kill-switch',
        frameworks: '資通安全事件通報及應變辦法 · 資通系統防護基準 — 事件應變',
      },
      {
        capability: 'Data classification + egress',
        frameworks: '個人資料保護法 · 資通安全責任等級分級辦法 — 資料分級',
      },
      {
        capability: 'AI-governance alignment',
        frameworks: '人工智慧基本法（principle-level, no penalties）· 行政院生成式 AI 參考指引',
      },
      {
        capability: 'Supply-chain provenance',
        frameworks: '大陸廠牌資通訊產品禁令 — dependency / BOM provenance',
      },
    ],
  ...
  JP: {
    ...
    crosswalk: [
      {
        capability: 'Signed decision ledger',
        frameworks: 'NISC 統一基準群（R7）· FISC 安全対策基準 第14版 · NIST 800-53 AU',
      },
      {
        capability: 'Policy-as-code + least-privilege',
        frameworks: 'デジタル庁 DS-920 v2.0 · NISC 統一基準',
      },
      {
        capability: 'Human approval + traceable log',
        frameworks: 'AI事業者ガイドライン v1.2（input → tool → conclusion）',
      },
      {
        capability: 'Data classification + egress',
        frameworks: '個人情報保護法 · 経済安全保障推進法',
      },
    ],
  ...
  SG: {
    ...
    crosswalk: [
      {
        capability: 'Signed decision ledger',
        frameworks: 'IM8 (OSCAL machine-readable) · NIST 800-53 AU',
      },
      {
        capability: 'Human approval + technical controls',
        frameworks:
          'IMDA Model AI Governance Framework for Agentic AI v1.0 · CSA Securing Agentic AI Addendum',
      },
      {
        capability: 'Supply-chain + runtime security',
        frameworks: 'Cybersecurity (Amendment) Act 2024 · CCoP 2.0',
      },
      {
        capability: 'Data classification + contractor obligations',
        frameworks: 'PDPA · IM8 data classification L0/1/2',
      },
    ],
  ...
  AE: {
    ...
    crosswalk: [
      {
        capability: 'Signed decision ledger',
        frameworks: 'UAE Information Assurance (IA) Standard V2 · NIST 800-53 AU',
      },
      {
        capability: 'Emirate-level controls',
        frameworks: 'DESC ISR v3.0 (Dubai) · ADDA NIAF (Abu Dhabi)',
      },
      {
        capability: 'Data protection + autonomous systems',
        frameworks: 'Federal PDPL · DIFC Regulation 10',
      },
  ...
  EU: {
    ...
    crosswalk: [
      {
        capability: 'Signed ledger + automatic event logging',
        frameworks: 'EU AI Act Art. 12 · Art. 26 (logs ≥ 6 mo) · NIST 800-53 AU',
      },
      {
        capability: 'Human oversight + kill-switch',
        frameworks: 'EU AI Act Art. 14 · Art. 27 (public-sector FRIA)',
      },
      { capability: 'Supply-chain + vulnerability handling', frameworks: 'NIS2 · CRA' },
      {
        capability: 'Cloud security + provenance',
        frameworks: 'BSI C5:2026 · ANSSI SecNumCloud 3.2 · EUCC',
      },
    ],
  ...
  KR: {
    ...
    crosswalk: [
      {
        capability: 'Signed ledger + document retention',
        frameworks: 'AI 기본법 시행령 (5-yr retention) · 국가정보보안기본지침 · NIST 800-53 AU',
      },
      {
        capability: 'High-impact AI controls + human oversight',
        frameworks: 'AI 기본법 · NIS agentic-AI security guidebook',
      },
      { capability: 'Certified crypto module', frameworks: 'KCMVP (전자정부법 §56 → 시행령 §69)' },
      {
        capability: 'Security-product assurance',
        frameworks: 'domestic CC / 보안기능확인서 · K-ISMS · CSAP',
      },
    ],
  ...
  SA: {
    ...
    crosswalk: [
      {
        capability: 'Signed ledger + certified crypto',
        frameworks: 'NCA ECC-2:2024 · NCA NCS-1:2020 · NIST 800-53 AU',
      },
      ...
      {
        capability: 'AI-governance alignment',
        frameworks: 'SDAIA Generative AI Guidelines for Government (non-binding)',
      },
    ],
...
export const GENERIC_COUNTRY: SovereignCountry = {
  ...
  crosswalk: [
    {
      capability: 'Signed, tamper-evident decision ledger',
      frameworks: 'EU AI Act Art. 12 (logging) · NIST 800-53 AU',
    },
    {
      capability: 'Policy-as-code + least-privilege identity',
      frameworks: 'NIST 800-53 AC · ISO/IEC 42001',
    },
    {
      capability: 'Signed, versioned policy distribution',
      frameworks: 'NIST 800-53 CM (anti-rollback)',
    },
    {
      capability: 'Classification, egress & jurisdiction control',
      frameworks: 'NIST 800-53 SC · CUI handling',
    },
    {
      capability: 'Human approval, break-glass, kill-switch',
      frameworks: 'NIST 800-53 IR · human oversight (AI Act)',
    },
    {
      capability: 'Air-gap signed delivery + supply-chain trust',
      frameworks: 'SLSA-style provenance · supply-chain (SR)',
    },
  ],

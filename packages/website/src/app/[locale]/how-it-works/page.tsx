  ...
  step: [
    {
      ...
      position: 1,
      name: 'Detect',
      text: 'Rule-based scanning with 71 ATR (Agent Threat Rules) catches known AI agent threats locally -- prompt injection, tool poisoning, credential exfiltration.',
    },
    {
      '@type': 'HowToStep',
      position: 2,

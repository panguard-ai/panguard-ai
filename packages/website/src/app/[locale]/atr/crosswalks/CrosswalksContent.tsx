...
const CROSSWALKS: readonly Crosswalk[] = [
  {
    ...
    coverage: '10 / 10',
    noteEn: '77 rule-to-category mappings; every Agentic Top 10 category has at least 4 ATR rules detecting it.',
  ...
  },
  {
    ...
    ownerZh: 'OWASP Gen AI Security Project',
    coverage: '10 / 10',
    noteEn: 'Per-rule compliance.owasp_llm field; LLM01 prompt injection has the heaviest coverage.',
  ...
  },
  {
    ...
    noteEn: 'ATR is to ATLAS what Sigma is to ATT&CK — the executable layer for ATLAS adversarial TTPs.',
  ...
  },
  {
    ...
    noteEn: 'Community OSCAL catalog v0.3 published 2026-05-10, covering all four AI RMF functions (Govern/Map/Measure/Manage). Acceptance email received 2026-05-11.',
    noteZh: '社群 OSCAL catalog v0.3 於 2026-05-10 釋出，涵蓋 AI RMF 四大功能 (Govern/Map/Measure/Manage)。2026-05-11 收到 acceptance email。',
  ...
  },
  {
    ...
    noteEn: 'Per-rule compliance.iso_iec_42001 field maps detections to specific Annex A clauses. Useful for AIMS certification audit evidence.',
  ...
  },
  {
    ...
    noteEn: 'Detections aligned with Art. 15 obligations for high-risk AI systems. Submission filed to EU AI Office Have-Your-Say (deadline 2026-06-03).',
    noteZh: '對應高風險 AI 系統的第 15 條 (準確性／穩健性／資安) 義務。已向 EU AI Office Have-Your-Say 提交 (截止 2026-06-03)。',
  },
  {
    id: 'safe-mcp',
    ...
    noteEn: 'Highest coverage of MCP-specific attack patterns. Detailed mapping in SAFE-MCP-MAPPING.md.',
  ...
  },
  {
    ...
    noteEn: 'Joint guidance published 2026-05-01 calls for runtime detection of known attack patterns; ATR is the open MIT-licensed detection layer the guidance requires.',
    noteZh: '2026-05-01 發佈的聯合指導要求對已知攻擊模式做執行期偵測；ATR 是該指導所需的開放 MIT 授權偵測層。',
  ...
  },
  {
    ...
    noteEn: 'Auto-sync from CISA KEV ingests new entries within 24 hours. CVE-2026-42208 (LiteLLM SQL injection, CVSS 9.3) detected by ATR-2026-00451.',
    noteZh: 'CISA KEV 自動同步 24 小時內納入新項目。CVE-2026-42208 (LiteLLM SQL injection, CVSS 9.3) 由 ATR-2026-00451 偵測。',
  },
];
    ...
    <SectionWrapper>
      <header className="mb-12 max-w-3xl">
        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-xs font-medium text-slate-700">
          ...
          {isZh ? '對應 · 政策框架 ↔ 可執行偵測' : 'Crosswalks · Policy frameworks ↔ executable detection'}
        </div>
      ...
      <SectionTitle
        ...
        subtitle={isZh ? '每條對應在 ATR repo 中均有 .md 或結構化資料' : 'Each mapping has a .md or structured artifact in the ATR repo'}
      />

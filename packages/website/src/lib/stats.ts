 ...
 *   config/sigma-rules/       -> 3,193 YAML files (3,110 community + 45 custom + 38 auto-generated)
 *   config/yara-rules/        -> 5,938 rule definitions across 969 files (923 community + 3 custom + 43 auto-generated)
...
export const STATS = {
  ...
  threatIntel: {
    sources: 11,
    activeSources: 10,
    validatedRecords: 1_800,
    autoGeneratedSigma: 38,

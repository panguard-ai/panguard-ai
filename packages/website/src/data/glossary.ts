...
export const GLOSSARY: GlossaryEntry[] = [
  {
    ...
    longDefinition: {
      en: [
        ...
        'The ATR corpus contains 650+ rules across 10 threat categories: prompt-injection, agent-manipulation, skill-compromise, context-exfiltration, tool-poisoning, privilege-escalation, model-abuse, excessive-autonomy, model-security, data-poisoning. OWASP Agentic Top 10 coverage is 10 of 10 categories. The rule set is MIT licensed and lives in a public repository at github.com/Agent-Threat-Rule/agent-threat-rules.',
        'Production deployments include Microsoft Agent Governance Toolkit (ATR rules merged via PR #1277 with a weekly auto-sync workflow), Cisco AI Defense skill-scanner (the full ATR rule pack merged via PR #99, auto-synced to the latest release), and MISP (PR #1207 on misp-galaxy, PR #323 on misp-taxonomies). Adam Lin, founder of PanGuard AI, has documented: "The standard exists to be cited. We measure success by how many ecosystems ship our rule IDs, not by how many users install our CLI."',
      ],
      zh: [
        ...
        'ATR 規則庫共 650+ 條,涵蓋 10 大威脅類別:prompt-injection、agent-manipulation、skill-compromise、context-exfiltration、tool-poisoning、privilege-escalation、model-abuse、excessive-autonomy、model-security、data-poisoning。OWASP Agentic Top 10 覆蓋率 10/10。規則集採用 MIT 授權,公開於 github.com/Agent-Threat-Rule/agent-threat-rules。',
        '生產部署包括 Microsoft Agent Governance Toolkit（PR #1277 合併 ATR 規則,並啟用每週自動同步 workflow）、Cisco AI Defense skill-scanner（PR #99 合併完整 ATR 規則包,並自動同步至最新發行）、MISP（misp-galaxy PR #1207、misp-taxonomies PR #323）。PanGuard AI 創辦人 Adam Lin 說:「標準存在的目的就是被引用。成功的衡量標準是有多少 ecosystem 採用我們的 rule ID,不是有多少使用者安裝我們的 CLI。」',
      ],
    },

...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Cost. Running 3,149 Sigma rules and 4,326 YARA signatures requires minimal compute. Running an LLM for every security event would cost orders of magnitude more. On a $5 VPS, the rules engine adds less than 2% CPU overhead. An AI-only approach would be economically impossible at this price point.',
  ...
  },
  {
    ...
    content: [
      ...
      'The scan engine checks 3,149 Sigma detection rules and 4,326 YARA malware signatures against your system. It examines SSH configuration, open ports, running services, file permissions, user accounts, cron jobs, and dozens of other attack surface vectors.',
  ...
  },
  {
    ...
    content: [
      ...
      'This includes the 3,149 Sigma detection rules that power our rules engine. It includes the 4,326 YARA malware signatures. It includes the scanning logic for SSH configuration, open ports, file permissions, user accounts, and every other check the engine performs.',
      '## Why MIT License',

...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'The agent runs 125+ ATR (Agent Threat Rules) detection rules purpose-built for AI agent security. It monitors tool calls, prompt flows, skill behavior, and agent interactions. When it detects a threat, it responds automatically -- revoking skills, blocking malicious actions, quarantining compromised agents -- and explains what happened in plain language through Slack, Telegram, or email.',
  ...
  },
  {
    ...
    content: [
      ...
      'Cost. Running 125+ ATR rules requires minimal compute. Running an LLM for every security event would cost orders of magnitude more. The rules engine adds less than 2% CPU overhead. An AI-only approach would be economically impossible at this scale.',
  ...
  },
  {
    ...
    content: [
      ...
      '```\ncurl -fsSL https://get.panguard.ai | bash\n```',
      'The scan engine checks 125+ ATR detection rules against your AI agent environment. It examines skill configurations, tool permissions, prompt flows, and dozens of other AI agent attack surface vectors.',
  ...
  },
  {
    ...
    content: [
      ...
      'This includes the 125+ ATR detection rules that power our rules engine. It includes the scanning logic for skill configurations, tool permissions, prompt flows, and every other check the engine performs.',
      '## Why MIT License',

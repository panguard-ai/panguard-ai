...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      'SAFE-MCP will define what needs to be secured. ATR provides 71 executable rules that detect these attacks in real time. They solve different problems at different layers:',
  ...
  },
  {
    ...
    content: [
      ...
      '## 你現在就能做的事',
      '安裝 PanGuard 掃描本地 Skills：\n\n```bash\nnpm install -g @panguard-ai/panguard && pga up\n```\n\n這會用全部 71 條 ATR 規則掃描已安裝的 Skills，產出逐一的風險報告。大約 60 秒。掃描結果會回饋 Threat Cloud，每次掃描都讓整個偵測網路更強。',
  ...
  },
  {
    ...
    excerpt:
      'ATR（Agent Threat Rules）是針對 AI Agent 安全威脅的開放偵測標準。71 條 YAML 規則。OWASP Agentic Top 10 全覆蓋。網路有 Snort，端點有 Sigma，AI Agent 有 ATR。',
    category: 'Product Updates',
    date: '2026-03-21',
    author: 'Panguard AI Team',
    readingTime: '8 min',
  ...
  },
  {
    ...
    title: 'OWASP Agentic Top 10：71 條 ATR 規則如何覆蓋全部 10 個類別',
    excerpt:
  ...
  },
  {
    ...
    content: [
      ...
      'MCP03 -- Tool Poisoning: Our core strength. 13 prompt injection patterns + 71 ATR detection rules + context signal engine. We catch hidden instructions in tool descriptions, `<IMPORTANT>` block stealth attacks, and silent data exfiltration commands.',
  ...
  },
  {
    ...
    content: [
      ...
      'The agent runs 71 ATR (Agent Threat Rules) detection rules purpose-built for AI agent security. It monitors tool calls, prompt flows, skill behavior, and agent interactions. When it detects a threat, it responds automatically -- revoking skills, blocking malicious actions, quarantining compromised agents -- and explains what happened in plain language through Slack, Telegram, or email.',
  ...
  },
  {
    ...
    content: [
      ...
      'Cost. Running 71 ATR rules requires minimal compute. Running an LLM for every security event would cost orders of magnitude more. The rules engine adds less than 2% CPU overhead. An AI-only approach would be economically impossible at this scale.',
  ...
  },
  {
    ...
    content: [
      ...
      '```\ncurl -fsSL https://get.panguard.ai | bash\n```',
      'The scan engine checks 71 ATR detection rules against your AI agent environment. It examines skill configurations, tool permissions, prompt flows, and dozens of other AI agent attack surface vectors.',
  ...
  },
  {
    ...
    content: [
      ...
      'This includes the 71 ATR detection rules that power our rules engine. It includes the scanning logic for skill configurations, tool permissions, prompt flows, and every other check the engine performs.',
      '## Why MIT License',
  ...
  },
  {
    ...
    content: [
      ...
      '## 71 Rules Covering 9 Attack Categories',
      'ATR ships with 71 detection rules across 9 categories:',

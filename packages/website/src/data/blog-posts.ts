...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "The scan engine checks 3,155 Sigma detection rules and 313 YARA malware signatures against your system. It examines SSH configuration, open ports, running services, file permissions, user accounts, cron jobs, and dozens of other attack surface vectors.",

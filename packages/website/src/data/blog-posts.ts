...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Medium confidence detections (70-95%) generate real-time alerts with full context through Slack, Discord, or LINE. The security team can review the evidence and decide whether to escalate.',
  ...
  },
  {
    ...
    content: [
      ...
      'Panguard Chat integrates with Slack, Discord, LINE, and Telegram. Each platform gets native formatting -- rich embeds in Slack, markdown in Discord, carousel cards in LINE. The experience feels native to each platform, not like a bot dumping raw text.',
  ...
  },
  {
    ...
    content: [
      ...
      'This includes the 3,158 Sigma detection rules that power our rules engine. It includes the 425 YARA malware signatures. It includes the scanning logic for SSH configuration, open ports, file permissions, user accounts, and every other check the engine performs.',
      '## Why MIT License',
      ...
      'Since launch, the community has contributed 47 new Sigma rules and 12 YARA signatures. These contributions caught real threats that our internal team had not yet cataloged. That is the power of open-source security -- the collective observation capability of the global security community, packaged into a tool anyone can run.',
      '## Try It',

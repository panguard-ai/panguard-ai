...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '- **L2 Audit** — 🟢 Shipped. `pga scan` on MCP configs + SKILL.md, 324 ATR rules, 97.1% recall on NVIDIA Garak (666 adversarial prompts), 0.48% FP on 3,115 real-world samples.',
      ...
      '## Numbers that matter',
      "The 324 ATR detection rules are not ours. They are the community's. We maintain the standard, the pipeline, and the benchmarks:",
      '- **311 rules**, MIT-licensed, in the [Agent Threat Rules](https://github.com/Agent-Threat-Rule/agent-threat-rules) repo',
  ...
  },
  {
    ...
    content: [
      ...
      '- **L2 Audit** — 🟢 已出貨。`pga scan` 掃 MCP config + SKILL.md,311 條 ATR 規則,NVIDIA Garak 97.1% recall (666 對抗樣本),3,115 個真實樣本 0.48% FP。',
      ...
      '- **311 條規則**,MIT 授權,放在 [Agent Threat Rules](https://github.com/Agent-Threat-Rule/agent-threat-rules) repo',
...

  {
    ...
    content: [
      ...
      '113 rules. 9 threat categories. Sub-5ms latency. MIT licensed. The ecosystem needs a shared defense, and the scan data shows exactly why.',
      '---',

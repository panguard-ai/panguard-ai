...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Panguard Skill Auditor is an automated security scanner purpose-built for AI agent skills. It runs 6 checks in under 1 second and produces a quantitative risk score (0-100) instead of a subjective "looks fine."',
      'Install it:',
      '```bash\ncurl -fsSL https://get.panguard.ai | bash\n```',
      'Audit any skill:',

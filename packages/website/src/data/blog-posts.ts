...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'A badge that says "Certified Secure" implies completeness. It suggests that everything dangerous has been found and eliminated. At 61.4% recall, we cannot make that claim. "ATR Scanned" means: this package has been analyzed against 108 known attack patterns and no threats were detected. It does not mean the package is safe. It means it passed the checks we have.',
  ...
  },
  {
    ...
    content: [
      ...
      '寫著「Certified Secure」的徽章暗示完整性。它暗示所有危險都已被發現和消除。在 61.4% 召回率下，我們無法做這個聲明。「ATR Scanned」的意思是：這個套件已被 108 條已知攻擊模式分析過，未偵測到威脅。不代表套件是安全的，代表它通過了我們有的檢查。如果開發者看到「Certified」就不再審查便安裝，而套件包含一個 ATR 漏掉的改寫式注入，我們反而讓開發者更不安全——給了他們虛假的信心。',
      '## Snort 的先例',
  ...
  },
  {
    ...
    excerpt:
      '框架是清單，ATR 是武器。OWASP Agentic Top 10 告訴你有哪些風險，ATR 的 108 條規則幫你真正擋下來。完整對應表。',
    category: 'Compliance',
    date: '2026-04-09',
    author: 'ATR Research',
    readingTime: '8 min',

...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'ATR ships as a single npm package with 650+ rules across 10 categories. Independent benchmarks: 99.7 percent precision and 63.9 percent recall on PINT (850 samples), 98 percent recall on 650 samples for NVIDIA Garak, 100 percent precision and 89.7 percent recall on the 341-sample self-test corpus. Sub-millisecond per-rule latency.',
  ...
  },
  {
    ...
    content: [
      ...
      'ATR ships 650+ rules across 10 categories. Self-test corpus: 100 percent precision, 89.7 percent recall on 341 samples. PINT external corpus: 99.7 percent precision, 63.9 percent recall on 850 samples. Garak: 98% recall on 650 samples. Detection runs sub-millisecond per scan.',

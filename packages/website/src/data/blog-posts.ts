...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "I scanned 96,096 AI agent skills across six public registries and found 751 confirmed malicious. Most attacked at install time, before any runtime guard could see them.",
  ...
  },
  {
    ...
    excerpt: "我掃描了六個公開 registry 上的 96,096 個 AI agent skill，發現 751 個確認惡意。多數在安裝當下就發動攻擊，早於任何 runtime 防護能看見它們之前。",
    category: "Threat Intelligence",
    date: "2026-06-20",
    author: "Adam Lin",
    readingTime: "8 分鐘閱讀",
  ...
  },
  {
    ...
    title: "OWASP Agentic Top 10 (2026): A Field Guide to Executable Detection for All 10 Categories",
    excerpt: "The OWASP Agentic Top 10 names ten agent risks; ATR ships 866 rule-to-category mappings covering all 10, nine at STRONG strength and one (ASI10) at MODERATE.",
  ...
  },
  {
    ...
    excerpt: "OWASP Agentic Top 10 列出十種 agent 風險；ATR 提供 866 條規則對類別的映射，涵蓋全部 10 類，其中 9 類為 STRONG、1 類（ASI10）為 MODERATE。",
    category: "Engineering",
    date: "2026-06-23",
    author: "Panguard AI Team",
    readingTime: "8 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "A trusted MCP server added one BCC line in a version bump and quietly copied thousands of emails daily; signature scanning never saw it because the malicious version had a clean history.",
    category: "Threat Intelligence",
    date: "2026-06-25",
    author: "Adam Lin",
    readingTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "一個受信任的 MCP server 在一次版本更新裡加了一行 BCC，每天靜默複製數千封 email；特徵碼掃描完全看不到，因為那個惡意版本擁有乾淨的歷史。",
    category: "Threat Intelligence",
    date: "2026-06-25",
    author: "Adam Lin",
    readingTime: "8 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "Antivirus misses prompt injection because the attack is words, not code — no binary, no hash, no CVE to match. ATR detects it by provenance and intent instead.",
    category: "Engineering",
    date: "2026-06-27",
    author: "Adam Lin",
  ...
  },
  {
    ...
    excerpt: "防毒軟體看不見提示詞注入,因為攻擊是文字而非程式碼,沒有二進位檔、沒有雜湊、沒有 CVE 可比對。ATR 改以來源與意圖偵測。",
    category: "Engineering",
    date: "2026-06-27",
    author: "Adam Lin",
    readingTime: "7 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "Tool poisoning hides instructions inside an MCP tool's description text, which the agent reads and obeys before the tool's code ever executes.",
    category: "Threat Intelligence",
    date: "2026-06-29",
    author: "Panguard AI Team",
    readingTime: "7 min read",
  ...
  },
  {
    ...
    excerpt: "工具投毒把指令藏在 MCP 工具的描述文字裡，Agent 讀到就照做，而工具的程式碼此時一行都還沒跑。",
    category: "Threat Intelligence",
    date: "2026-06-29",
    author: "Panguard AI Team",
    readingTime: "7 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "Run `pga scan <target>` before install. It checks the code against nearly 690 ATR rules for prompt injection, secrets, and obfuscation, and flags criticals in seconds.",
  ...
  },
  {
    ...
    excerpt: "安裝前先跑 `pga scan <target>`。它會用將近 690 條 ATR 規則檢查 prompt injection、密鑰外洩與混淆,幾秒內標出嚴重問題。",
    category: "Product Updates",
    date: "2026-07-01",
    author: "Panguard AI Team",
    readingTime: "6 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "Five real MCP CVE classes hit production in 2026: network-binding RCE, SSRF credential theft, config/hook exploitation, trusted-server supply-chain poisoning, and tool-description injection.",
    category: "Threat Intelligence",
    date: "2026-07-02",
    author: "Adam Lin",
    readingTime: "7 min read",
  ...
  },
  {
    ...
    excerpt: "2026 年有五類真實 MCP CVE 打進 production:網路綁定 RCE、SSRF 憑證竊取、設定與 hook 濫用、可信伺服器供應鏈污染,以及 tool description 注入。",
    category: "Threat Intelligence",
    date: "2026-07-02",
    author: "Adam Lin",
    readingTime: "7 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "PanGuard reports lane-keyed false positives (~0.24% enforce, ~9% hunt) because a single blended FP number hides which detections you can trust to block.",
    category: "Engineering",
    date: "2026-07-03",
    author: "Adam Lin",
    readingTime: "6 min read",
  ...
  },
  {
    ...
    excerpt: "PanGuard 以 lane 為單位呈現誤報(enforce lane 約 0.24%、hunt lane 約 9%),因為單一混合的 FP 數字會遮蔽你真正該信任哪些偵測去攔阻。",
    category: "Engineering",
    date: "2026-07-03",
    author: "Adam Lin",
    readingTime: "6 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "ATR reports one benchmark per corpus with full context: garak 97.2% recall, PINT-format 99.7% precision, HackAPrompt 69.6% recall, SKILL.md 100% recall. Never one engine-wide number.",
    category: "Engineering",
    date: "2026-07-04",
    author: "Panguard AI Team",
    readingTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "ATR 每條 benchmark 都對應特定語料:garak 97.2% recall、PINT-format 99.7% precision、HackAPrompt 69.6% recall、SKILL.md 100% recall。從不給單一引擎級數字。",
    category: "Engineering",
    date: "2026-07-04",
    author: "Panguard AI Team",
    readingTime: "8 分鐘閱讀",
  ...
  },
  {
    ...
    title: "From Sigma and YARA to AI Agents: Why 20 Years of Detection Engineering Didn't Transfer",
    excerpt: "Sigma and YARA rules don't catch AI agent attacks because the attack surface is words, not signatures. ATR is the Sigma layer for agents, and a free MIT migrator ports your existing rules.",
    category: "Engineering",
    date: "2026-07-04",
    author: "Adam Lin",
    readingTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "既有的 Sigma 與 YARA 規則抓不到 AI agent 攻擊,因為攻擊面是文字,不是簽章。ATR 是 agent 的 Sigma 層,免費 MIT 遷移器把你的舊規則轉過來。",
    category: "Engineering",
    date: "2026-07-04",
    author: "Adam Lin",
    readingTime: "8 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "Threat crystallization turns an AI's one-time reasoning about a new attack into a deterministic regex rule that runs in milliseconds for every install, with new-attack-to-shipped-rule in about an hour.",
    category: "Engineering",
    date: "2026-07-05",
    author: "Adam Lin",
    readingTime: "7 min read",
  ...
  },
  {
    ...
    excerpt: "威脅結晶化把 AI 對新攻擊的一次性推理,轉成每次安裝都能在毫秒內執行的確定性 regex 規則,新攻擊到上線規則只需約一小時。",
    category: "Engineering",
    date: "2026-07-05",
    author: "Adam Lin",
    readingTime: "7 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "Every incumbent secured a layer below where agents act. The tool-call layer, where agents actually get hijacked, was skipped, and it needs an open standard.",
    category: "Industry",
    date: "2026-07-05",
    author: "Adam Lin",
    readingTime: "8 min read",
    content: [
      ...
      "I am Adam Lin. I build and operate ATR, Agent Threat Rules, an open MIT-licensed detection standard for exactly this layer. This essay is the argument for why the agent action layer needs a neutral, open standard that even competitors adopt, rather than one more single-vendor box. The evidence that the ecosystem already agrees is that Cisco, Microsoft, MISP, Gen Digital, and SigmaHQ have each shipped ATR into their own products.",
      ...
      "Yes, and the proof is that direct competitors ship the same open rules. Here is what has merged into production, each backed by a merged pull request in the ATR ADOPTERS record.",
      "| Adopter | What shipped |\n|---|---|\n| Cisco AI Defense | ATR merged into its skill-scanner (PR #99) |\n| Microsoft Agent Governance Toolkit | 287-rule ATR pack, weekly auto-sync (PR #1277) |\n| MISP / CIRCL | ATR rule-ID taxonomy and threat-intel galaxy merged into MISP core |\n| Gen Digital (Norton / Avast) | ATR merged into Sage (PR #33) |\n| SigmaHQ | ATR listed in docs (PR #6015) |\n| Microsoft PyRIT | ATR integration merged (PR #1715) |\n| OWASP Agent Security Regression Harness | ATR merged (PR #74) |",
      ...
      "No. ATR is an independent, MIT-licensed open standard governed on its own. PanGuard is one product built on it, the same way vendors build on Sigma or CVE. Competitors like Cisco and Microsoft ship ATR directly.",
  ...
  },
  {
    ...
    excerpt: "每一家巨頭都守住了 agent 動作以下的那一層。真正發生劫持的工具呼叫層被跳過了,而它需要一套開放標準。",
    category: "Industry",
    date: "2026-07-05",
    author: "Adam Lin",
    readingTime: "8 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "Yes. Article 15 makes detecting adversarial attacks like prompt injection a legal duty for high-risk AI, enforced end-2027, not 2026.",
    category: "Compliance",
    date: "2026-07-06",
    author: "Panguard AI Team",
    readingTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "是的。第 15 條把偵測 prompt injection 等對抗式攻擊列為高風險 AI 的法律義務，2027 年底生效，不是 2026 年。",
    category: "Compliance",
    date: "2026-07-06",
    author: "Panguard AI Team",
    readingTime: "8 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "ATR aligns to 34 of 101 top-level MITRE ATLAS techniques and 13 of 16 tactics against the ATLAS v5.6.0 draft. This is the honest state of that crosswalk, gaps included.",
    category: "Engineering",
    date: "2026-07-06",
    author: "Panguard AI Team",
    readingTime: "7 min read",
  ...
  },
  {
    ...
    excerpt: "ATR 目前對齊 MITRE ATLAS 101 個頂層 technique 中的 34 個、16 個 tactic 中的 13 個，基準為 ATLAS v5.6.0 草案。這是這份 crosswalk 的誠實現況，含所有缺口。",
    category: "Engineering",
    date: "2026-07-06",
    author: "Panguard AI Team",
    readingTime: "7 分鐘閱讀",
  ...
  },
  {
    ...
    excerpt: "Every skill, MCP server, and tool you add to an AI agent is unreviewed code with keys to your machine. One command scans before load and guards at runtime.",
    category: "Product Updates",
    date: "2026-07-06",
    author: "Adam Lin",
    readingTime: "7 min read",
  ...
  },
  {
    ...
    excerpt: "你往 AI Agent 裝的每一個 skill、MCP server、工具，都是拿著你機器鑰匙、卻沒人審過的程式碼。一行指令，載入前先掃、執行時看守。",
    category: "Product Updates",
    date: "2026-07-06",
    author: "Adam Lin",
    readingTime: "7 分鐘閱讀",
  ...
  },
  {
    ...
    content: [
      ...
      '_Adam Lin maintains [Agent Threat Rules](https://github.com/Agent-Threat-Rule/agent-threat-rules), an open MIT-licensed detection corpus for AI agent threats. ATR rules are in production at Microsoft, Cisco, and MISP. Founder of Panguard AI, building the commercial product around the ATR standard. Reach: adam@agentthreatrule.org_',
    ],
  },
  {
    ...
    content: [
      ...
      '_Adam Lin 維護 [Agent Threat Rules](https://github.com/Agent-Threat-Rule/agent-threat-rules),一套開源、MIT 授權的 AI agent 威脅偵測語料庫。ATR 規則已在 Microsoft、Cisco、MISP 生產環境運行。Panguard AI 創辦人,圍繞 ATR 標準打造商業產品。聯絡:adam@agentthreatrule.org_',
    ],
  },
  {
    ...
    content: [
      ...
      '_Adam Lin maintains [Agent Threat Rules](https://github.com/Agent-Threat-Rule/agent-threat-rules), an open MIT-licensed detection corpus for AI agent threats. ATR rules are in production at Microsoft, Cisco, and MISP. Founder of Panguard AI, a Delaware C-Corp building the commercial product around the ATR standard. Reach: adam@agentthreatrule.org_',
    ],
  },
  {
    ...
    content: [
      ...
      '_Adam Lin 維護 [Agent Threat Rules](https://github.com/Agent-Threat-Rule/agent-threat-rules)，一個 MIT 授權的 AI agent 威脅偵測 corpus。ATR 規則在 Microsoft、Cisco、MISP 都在跑。同時是 Panguard AI 的 founder（Delaware C-Corp，做 ATR 標準的商業化產品）。聯絡：adam@agentthreatrule.org_',
    ],
  },
  {
  ...
  },
  {
    ...
    excerpt:
      'NSA 在 2026 年 5 月發布了 17 頁的 MCP 安全風險指引，卻沒有點名任何偵測框架。ATR 填補了這個空缺：433 條規則涵蓋 NSA 五大風險類別，已在微軟、思科、MISP 和 OWASP 正式部署。',
    category: 'Threat Intelligence',
    date: '2026-05-27',
    author: 'Panguard AI Team',
    readingTime: '6 min',

...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      'In March 2026, Google DeepMind published [*AI Agent Traps: A Taxonomy of Adversarial Attacks on Autonomous Agents*](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6372438) (SSRN 6372438). Six attack categories. 80-86% success rate on production agents. A public case: Microsoft 365 Copilot scoring **10/10 on Remote Control** across every category the team tested.',
      ...
      '- **Gen Digital Sage** — runtime guardrails (Layer 3 only)',
      ...
      'Every vendor covers one or two layers. Every CISO ends up buying five SKUs with gaps between them. This is not anyone\'s fault — agent security is too broad a problem for a single point product. But the buyer is left integrating the pieces themselves.',
      ...
      '```',
      'Each layer is a real function with real buyers. Miss a layer and a category of attacks walks through. The 6 DeepMind categories map cleanly across L2-L6; L1 and L7 are what enterprise procurement has been asking for and no one has shipped end-to-end yet.',
      '## Our honest 6/7 coverage',
      ...
      '- **L5 Deceive** — 🟢 Shipped. Trap daemon profiles attackers in a contained honeypot.',
      '- **L6 Respond** — 🟢 Shipped. Auto-block, IP quarantine, Slack/email alerts, playbook execution.',
      '- **L7 Govern** — 🟡 Partial. Audit log + Threat Cloud ship today. 4-framework compliance mapping (EU AI Act / Colorado / NIST AI RMF / ISO 42001) lands Q2 2026. AIAM (Phase 5) Q3 2026.',
      ...
      '- NVIDIA Garak integration pending review',
      'Three ecosystem merges in six weeks is not us getting lucky. It is evidence that the detection layer wants a protocol, and ATR is filling that slot.',
      '## Why consolidation wins',
      'In 2010, every endpoint had four agents: AV, firewall, IDS, DLP. CISOs hated it. CrowdStrike launched EDR, consolidated the stack, and now owns the category worth $100B+ in market cap. The reason the consolidation worked was not a better product — it was a better *architecture*. One agent, one console, seven functions.',
  ...
  },
  {
    ...
    title: '為什麼 AI Agent 安全需要平台,不是再一個工具',
    excerpt:
      '產業一直缺的 7 層防禦架構。目前每家廠商只覆蓋 1-2 層 — Sage 做 runtime、Cisco 做掃描、Microsoft 做治理、Straiker 做偵測。我們認為下一個轉折是整合成 full-stack Agent Security Platform (ASP),並公開 PanGuard 今天誠實的 6/7 層覆蓋狀況與 2026 Q3 達到 7/7 的時程。',
    category: 'Industry',
    date: '2026-04-22',
    author: 'KUAN-HSIN LIN',
    readingTime: '7 分鐘',
    content: [
      '## 攻擊分類學已經公開',
      '2026 年 3 月,Google DeepMind 發表 [*AI Agent Traps: A Taxonomy of Adversarial Attacks on Autonomous Agents*](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6372438) (SSRN 6372438)。六個攻擊類別。在 production agent 上 80-86% 成功率。一個公開案例:Microsoft 365 Copilot 在團隊測試的每一類攻擊上都拿到 **10/10 Remote Control**。',
      ...
      '- **Apono** — 授權 + 治理 (L6, L7)',
      '每家廠商只做 1-2 層。每位 CISO 最後買 5 個 SKU,中間還有 gap。這不是任何人的錯 — agent 安全本來就是個太廣的問題,單一點產品做不完。但買方被迫自己整合這些碎片。',
      '## 7 層架構',
      ...
      '- **L5 Deceive** — 🟢 已出貨。Trap daemon 在受控蜜罐裡側錄攻擊者。',
      '- **L6 Respond** — 🟢 已出貨。自動阻斷、IP 隔離、Slack/email 告警、劇本執行。',
      '- **L7 Govern** — 🟡 部分。稽核日誌 + Threat Cloud 今天已出。4 框架合規對應 (EU AI Act / Colorado / NIST AI RMF / ISO 42001) 2026 Q2 落地。AIAM (Phase 5) 2026 Q3。',
      '我們計畫 2026 Q3 完成 7/7。時程在 [panguard.ai](https://panguard.ai)。沒有假打勾。',
      '## 有分量的數字',
      ...
      '- NVIDIA Garak 整合審查中',
      '六週內三個生態系 merge 不是運氣。是「偵測層想要一個協定」的證據,而 ATR 正在填這個位子。',
      '## 為什麼整合會贏',
      '2010 年每個 endpoint 都有四個 agent:AV、firewall、IDS、DLP。CISO 恨透了。CrowdStrike 推 EDR,整合這個堆疊,今天這個品類市值超過千億美元。整合能成功不是因為產品更好,是因為*架構*更好。一個 agent,一個 console,七個功能。',
      '2026 年的 agent 安全看起來就像 2010 年的 endpoint 安全。五家廠商、五個儀表板、五份合約、中間攻擊者先找到的 gap。Agent Security Platform 這個品類正要用同樣的形狀整合。',
      '我們不是在預測這個。我們在建造它。',
      '## 接下來怎麼做',
      '如果你在出 agent:',
  ...
  },
  {
    ...
    title: "Anthropic Won't Patch. 200,000 MCP Servers at Risk. Deterministic Detection Is Now the Only Contract Left.",
    excerpt:

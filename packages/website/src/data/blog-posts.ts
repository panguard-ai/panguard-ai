...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '## Getting Started',
      'One command. 29 rules. Zero configuration.',
      ...
      'You do not need to write rules. You do not need to configure detection patterns. The default rule set covers the most common attack patterns across all 8 ATR threat categories. As new threats emerge, updated rules are distributed automatically.',
      '## The Flywheel',
  ...
  },
  {
    ...
    content: [
      ...
      '## The 8 Attack Categories',
      'ATR organizes threats into 8 categories, each targeting a different aspect of the agent interaction pipeline:',
      ...
      '- **Review the rules**: The initial rule set covers 40+ detection patterns across all 8 categories',
  ...
  },
  {
    ...
    content: [
      ...
      '- **Examples**: The full initial rule set with 40+ rules across all 8 categories',

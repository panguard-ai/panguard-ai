...
const BUCKETS = [
  { labelKey: 'safe' as const, count: eco.findingsClean, percent: safePercent, color: 'text-emerald-400', bg: 'bg-emerald-400/10', border: 'border-emerald-400/30' },
  { labelKey: 'critical' as const, count: eco.findingsCritical, percent: critPercent, color: 'text-red-400', bg: 'bg-red-400/10', border: 'border-red-400/30' },
  { labelKey: 'high' as const, count: eco.findingsHigh, percent: highPercent, color: 'text-orange-400', bg: 'bg-orange-400/10', border: 'border-orange-400/30' },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <FadeInUp delay={0.15} className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-12">
          {BUCKETS.map((b) => (
            ...
            >
              <p className={`text-2xl sm:text-3xl font-extrabold ${b.color}`}>
                {b.percent}%
              </p>

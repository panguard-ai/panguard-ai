          ...
          <Card padding="lg" className="h-full">
            ...
            <div className="space-y-2">
              {[0, 1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 bg-surface-0 rounded-lg px-3 py-2"
                >
                  <span className="text-xs font-mono text-brand-sage w-4 text-right">
                    {i + 1}
                  </span>

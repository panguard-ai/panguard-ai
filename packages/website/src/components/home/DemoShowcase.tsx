  ...
  [
    {
      ...
      alt: 'PanGuard dashboard Overview — PROTECTED posture at a glance, 747 ATR rules active, both detection layers on-device and active, optional Layer C and collective defense off by default',
      width: 1920,
      height: 1080,
    },
    {
    ...
    },
    {
      ...
      alt: 'PanGuard Coverage — agent platforms detected on the machine and whether each is protected: 7 detected, 6 configured (Claude Code, Claude Desktop, Cursor, OpenClaw, Codex CLI, Gemini CLI), 1 detected-but-unconfigured',
      width: 1920,
      height: 1080,
    },
    {

 ...
 * 將明文憑證遷移到安全儲存
 *
 * @module @openclaw/security-hardening/credentials/migration
 */
...
/** Default OpenClaw credentials directory / 預設 OpenClaw 憑證目錄 */
const DEFAULT_CREDENTIALS_DIR = join(homedir(), '.openclaw', 'credentials');

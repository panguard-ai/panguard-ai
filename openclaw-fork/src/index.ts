/**
 * OpenClaw Security Hardening Library
 * OpenClaw 安全強化函式庫
 *
 * Provides security fixes and hardening for OpenClaw AI Agent framework.
 * Addresses CVE-2026-25253, credential storage, skill sandboxing,
 * permission minimization, and audit logging.
 * 為 OpenClaw AI Agent 框架提供安全修復和強化。
 * 處理 CVE-2026-25253、憑證儲存、技能沙盒、權限最小化和稽核日誌。
 *
 * @module @openclaw/security-hardening
 */
